...
@section('title', $isAdd ? 'Thêm mới slide' : 'Cập nhật slide')
@section('pageTitle', $isAdd ? 'Thêm mới slide' : 'Cập nhật slide')
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal"
                    action="{{$isAdd ? url('admin/slides') : url('admin/slides/'.$slide->id)}}" method="post"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="position" placeholder=""
                                        name="position" value="{{ $isAdd ? 1 : $slide->position }}">
                                </div>
                            </div>
                        </div>
